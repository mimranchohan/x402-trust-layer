...
x402 Trust Layer is the **control plane** between AI agents and the open x402 marketplace. 68 paid HTTP APIs decide whether to pay, whom to trust, which rail to use, and how to audit or dispute settlements. No API keys — USDC micropayments on Base, Solana, and Polygon.
