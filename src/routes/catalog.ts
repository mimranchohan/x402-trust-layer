...
export function listEndpoints() {
  return [
    ...
    { path: "POST /api/guard/pre-x402-alchemy", price: `$${pricing.preX402GuardAlchemy}`, tier: "bundle" },
    { path: "POST /api/alchemy/paymaster-policy", price: "Free", tier: "security" },
    { path: "POST /api/alchemy/notify-webhook", price: "Free", tier: "security" },
    { path: "POST /api/alchemy/simulate-shield", price: "Free", tier: "intelligence" },
    { path: "POST /api/guard/pre-x402", price: `$${pricing.preX402Guard}`, tier: "bundle" },
    { path: "POST /api/guard/payload-sandbox", price: `$${pricing.payloadSandbox}`, tier: "bundle" },
    ...
    { path: "POST /api/trust-network/insurance/attest", price: `$${pricing.insuranceAttest}`, tier: "tier1" },
