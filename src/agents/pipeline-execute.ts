...
const _pipelineTimeoutRaw = parseInt(process.env.PIPELINE_TIMEOUT_MS ?? "8000", 10);
const PIPELINE_TIMEOUT_MS = Number.isFinite(_pipelineTimeoutRaw) && _pipelineTimeoutRaw > 0
  ? _pipelineTimeoutRaw
  : 8000;
